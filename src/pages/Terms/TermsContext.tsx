import { TextBold, TextTitle } from '../Privacy/PrivacyContext';
...
export const TermsContext = () => {
  return (
    <>
      ...
      <br />
      <p>
        Welcome to kingpad.finance! <br />
        These terms and conditions outline the rules and regulations for the use of King Finance's Website, located at
        kingworld.finance. <br />
        By accessing this website we assume you accept these terms and conditions. Do not continue to use
        kingworld.finance if you do not agree to take all of the terms and conditions stated on this page. <br />
        <br />
      ...
      <br />
      <br />
      <TextBold>Cookie</TextBold>
      <br />
      <p>
        We employ the use of cookies. By accessing Website Name, you agreed to use cookies in agreement with the Company
        Name's Privacy Policy. Most interactive websites use cookies to let us retrieve the user's details for each
      ...
      <br />
      <br />
      <TextBold>License</TextBold>
      <br />
      <p>
        Unless otherwise stated, King Finance and/or its licensors own the intellectual property rights for all material
        on kingworld.finance. All intellectual property rights are reserved. You may access this from kingworld.finance
        for your own personal use subjected to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from kingworld.finance</li>
        <li>Sell, rent or sub-license material from kingworld.finance</li>
        <li>Reproduce, duplicate or copy material from kingworld.finance</li>
        <li>Redistribute content from kingworld.finance</li>
      </ul>
      <br />
      <p>
        This Agreement shall begin on the date hereof. Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. King Finance does not filter, edit, publish
        or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of
        King Finance, its agents and/ or affiliates. Comments reflect the views and opinions of the person who post
        their views and opinions. To the extent permitted by applicable laws, King Finance shall not be liable for the
        Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
        posting of and/or appearance of the Comments on this website.{' '}
      </p>
      <br />
      <p>
        King Finance reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant King Finance a non-exclusive license to use, reproduce, edit and authorize others to use,
        reproduce and edit any of your Comments in any and all forms, formats or media.
      </p>
      <br />
      <br />
      <TextBold>Hyperlinking to our Content </TextBold>
      <br />
      ...
      <ul>
        ...
        <li>
          System wide Accredited Businesses except soliciting nonprofit organizations, charity shopping malls, and
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of King
        Finance; and (d) the link is in the context of general resource information.
      </p>
      <br />
      <p>
      ...
      <p>
        No use of King Finance's logo or other artwork will be allowed for linking absent a trademark license agreement.
      </p>
      <br />
      <br />
      <TextBold>iFrames</TextBold>
      <br />
      <p>
      ...
      <br />
      <br />
      <TextBold>Content Liability</TextBold>
      <br />
      <p>
      ...
      <br />
      <br />
      <TextBold>Reservation of Rights</TextBold>
      <br />
      <p>
      ...
      <br />
      <br />
      <TextBold>Removal of links from our website</TextBold>
      <br />
      <p>
